...
public class Browser extends JPanel{
    ...
    private void setDatePickers(){
        ...
        JDatePanelImpl datePanel1 = new JDatePanelImpl(modelbegin);
        datePanel1.setOpaque(true);
        datePanel1.setBackground(new Color(0,0,0,144));

        UtilDateModel modelend = new UtilDateModel();
        modelend.setDate(1988,1,1);
        JDatePanelImpl datePanel2 = new JDatePanelImpl(modelend);
        datePanel2.setOpaque(true);
        datePanel2.setBackground(new Color(0,0,0,144));

        beginPicker = new JDatePickerImpl(datePanel1);
        endPicker = new JDatePickerImpl(datePanel2);
    ...
    private void setCheckboxes(){
        ...
        checkBoxBody.setBounds(890,size*0+5,25,size);
        checkBoxTitle.setBounds(890,size*1+5,25,size);
    ...
    private void setTextboxAndButtons() {
        ...
        body.setBounds(0,size*0+5,890,size);
        title.setBounds(0,size*1+5,890,size);
    ...
    private void setFunctions() {
        buttonSearch.addActionListener(actionEvent -> { consult(); });
    }
